...
class RoofControlPlugin implements AccessoryPlugin {
    ...
    constructor(log: Logging, config: AccessoryConfig, api: API) {
        ...
        function createSwitchService(uuid: string, name: string, subtype: string, code: number) {
            ...
            service.getCharacteristic(hap.Characteristic.On)
                ...
                .on(CharacteristicEventTypes.SET, (value: CharacteristicValue, callback: CharacteristicSetCallback) => {
                    ...
                    if (roofControl && roofControlInited) {
                        roofControl.setTransmitting(uuid, code, switchOn, () => {
                            switchOn = false;
        ...
        this.switchOpenService  = createSwitchService(this.uuid, this.name, 'Open',  (code << 4) | 0x1);
        this.switchCloseService = createSwitchService(this.uuid, this.name, 'Close', (code << 4) | 0x2);
